...
example using fractions of PI."""
    ...
    def _draw_sectors(self):
        ...
        while l:
            ...
            add(Line(points=(centerx, centery, centerx + 10, centery + 10), width=1))
            a0 = a1
    ...
    def _draw_label(self, *t):
        ...
        print(f"center: {self.pos}, {self.centery}")
        self._labelIG.add(

            Line(points=[self.centerx + r1 * s, self.centery + r1 * c, 200, 100], width=1)
        )
